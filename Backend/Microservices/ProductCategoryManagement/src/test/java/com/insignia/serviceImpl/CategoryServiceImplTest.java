...
class CategoryServiceImplTest {
    ...
    void enableCategory_InvalidCategoryName_ThrowsInvalidInputParametersException() {
        ...
        when(categoryDaoInterface.findByCategoryName(anyString())).thenReturn(null);
    ...
    @Test
    void saveCategory_ValidInput_ReturnsCategoryResponse() throws InvalidInputParametersException, TokenExpiredException {
    ...
    @Test
    void getCategories_WithNullCategoryId_ReturnsAllCategories() throws TokenExpiredException, InvalidInputParametersException {

        CategoryRequest categoryRequest = new CategoryRequest();

        categoryRequest.setCustomerSequenceNumber(5L);
        categoryRequest.setExpirationDuration(15);
        List<ProductSubCategory> subCategories1 = Arrays.asList(
                new ProductSubCategory(),
                new ProductSubCategory()
        );

        List<ProductSubCategory> subCategories2 = Arrays.asList(
                new ProductSubCategory(),
                new ProductSubCategory()
        );

        List<ProductCategory> mockedCategories = Arrays.asList(
                new ProductCategory(1L, "Category1", "Desc1", "Path1", false, null,subCategories1),
                new ProductCategory(2L, "Category2", "Desc2", "Path2", false,null ,subCategories2)
        );

        when(categoryDaoInterface.fetchAllCategories()).thenReturn(mockedCategories);
    ...
    @Test
    void getCategories_WithCategoryId_ReturnsCategoryResponseList() throws TokenExpiredException, InvalidInputParametersException {
        ...
        doNothing().when(tokenDaoInterface).checkTokenValidity(any(), any());
        when(categoryDaoInterface.findByCategoryId(anyLong())).thenReturn(Optional.of(existingCategory));
        ...
        verify(tokenDaoInterface).checkTokenValidity(anyLong(), anyInt());
        verify(categoryDaoInterface).findByCategoryId(anyLong());
    }

    @Test
    void disableCategory_ValidInput_ReturnsSuccessMessage() throws InvalidInputParametersException, TokenExpiredException {
    ...
    @Test
    void updateCategory_ValidInput_ReturnsCategoryResponse() throws InvalidInputParametersException, TokenExpiredException {
    ...
    @Test
    void enableCategory_ValidInput_ReturnsCategoryResponse() throws InvalidInputParametersException, TokenExpiredException {
        ...
        doNothing().when(tokenDaoInterface).checkTokenValidity(any(), any());
        when(categoryDaoInterface.findByCategoryName(anyString())).thenReturn(existingCategory);
        when(categoryDaoInterface.saveCategory(any())).thenReturn(existingCategory);
        ...
        verify(tokenDaoInterface).checkTokenValidity(anyLong(), anyInt());
        verify(categoryDaoInterface).findByCategoryName(anyString());
        verify(categoryDaoInterface).saveCategory(any());
    }

...
public class CustomerAndSubscriptonLinkRequest {
	...
	public String toString() {
		return "CustomerAndSubscriptonLinkRequest [customerSequenceNumber=" + customerSequenceNumber
				+ ", expirationDuration=" + expirationDuration + ", subscriptionPlanSequenceNumber="
				+ subscriptionPlanSequenceNumber + ", isToForceDelete=" + isToForceDelete + "]";
	}

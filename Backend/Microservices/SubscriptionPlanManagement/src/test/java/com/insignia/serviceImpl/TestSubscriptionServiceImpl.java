...
public class TestSubscriptionServiceImpl {
	...
	public void testSaveSubscriptionDetails()
		...
		when(daoRepo.findByPlanIdAndPlanName(any(), any())).thenReturn(Optional.empty());
	...
	public void testDuplicateDataWithNEWSubscriptionDetailsException()
		...
		when(daoRepo.findByPlanIdAndPlanName(any(), any())).thenReturn(Optional.of(subscriptionDetails));
	...
	public void testUpdateSubscriptionDetails()
		...
		doNothing().when(tokenRepo).checkTokenValidity(any(), any());
		when(daoRepo.findBySequenceNumber(sequenceNumber)).thenReturn(Optional.of(subscriptionDetails));
	...
	public void testUpdateSubscriptionDetailsNotFound()
		...
		when(daoRepo.findBySequenceNumber(any())).thenReturn(Optional.empty());

		assertThrows(InvalidInputParametersException.class, () -> {

			serviceImpl.updateSubscriptionPlan(invalidRequest);
		});
		verify(daoRepo, times(1)).findBySequenceNumber(any());
	...
	public void testActiveSubscriptionPlan()
		...
		doNothing().when(tokenRepo).checkTokenValidity(any(), any());
		when(daoRepo.findByPlanIdAndPlanName(any(), any())).thenReturn(optional);
	...
	public void testActiveSubscriptionDetailsNotFoundException()
		...
		verify(daoRepo, times(1)).findByPlanIdAndPlanName(any(), any());
	...
	public void testGetSubscriptionDetails()
		...
		doNothing().when(tokenRepo).checkTokenValidity(any(), any());
		when(daoRepo.findBySequenceNumber(subscriptionRequest.getSequenceNumber()))
	...
	public void testGetSubscriptionDetailsByPlanIdAndPlanName()
		...
		when(daoRepo.findAllSubscriptionDetails()).thenReturn(subscriptionDetailsList);
		Optional<List<SubscriptionResponse>> subscriptionDetailsList = serviceImpl
				.getSubscriptionDetails(subscriptionRequest);
	...
	public void testDeleteSubscriptionDetailsWithPlanIdAndPlanName()
		...
		doNothing().when(daoRepo).deleteSubscriptionPlanByName(any(), any());
	...
	public void testDeleteSubscriptionDetails()
		...
		when(daoRepo.findBySequenceNumber(any())).thenReturn(Optional.of(subscriptionDetails));
		doNothing().when(daoRepo).deleteSubscriptionPlan(any());

...
public class TestProductSubscriptionLinkPlanServiceImpl {
	...
	public void testAssociateSubscriptionPlanWithCustomer()
		...
		when(subscriptionDaoInterface.findBySequenceNumber(any())).thenReturn(Optional.of(subscriptionDetails));
	...
	public void testAssociateSubscriptionPlan_SubscriptionIdIsNotPresentException()
		...
		when(subscriptionDaoInterface.findBySequenceNumber(subscriptonLinkRequest.getSubscriptionPlanSequenceNumber()))

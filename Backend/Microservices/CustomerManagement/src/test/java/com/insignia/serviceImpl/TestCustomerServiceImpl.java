...
public class TestCustomerServiceImpl {
	...
	void testGetCustomerAndStoreInformation() throws TokenExpiredException, ParseException {
		...
		Object[] customerStoreDetails = new Object[6];

		customerStoreDetails[0] = "Full Name";
		customerStoreDetails[1] = "2022-01-01";
		customerStoreDetails[2] = "Store Name";
		customerStoreDetails[3] = "Store Contact";
		customerStoreDetails[4] = "Store Address";
		customerStoreDetails[5] = "Business Type";

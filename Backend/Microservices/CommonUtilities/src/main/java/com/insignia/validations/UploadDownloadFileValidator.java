...
public class UploadDownloadFileValidator {
    ...
    public static void validateFunctionalObject(String value) throws InvalidInputParametersException {
        if (value == null || value == "" || value.trim().isBlank()) {
            throw new InvalidInputParametersException(FileUploadDownloadConstant.validateFunctionalObjectCode,
                    FileUploadDownloadConstant.validateFunctionalObjectName);
        }
    }
    ...
    public static void validateFileType(String value) throws InvalidInputParametersException {
        if (value == null || value == "" || value.trim().isBlank()) {
            throw new InvalidInputParametersException(FileUploadDownloadConstant.validateFileTypeCode,
                    FileUploadDownloadConstant.validateFileType);
        }
    }
